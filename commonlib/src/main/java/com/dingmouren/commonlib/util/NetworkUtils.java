...
public final class NetworkUtils {
    ...
    private NetworkUtils() {
        throw new UnsupportedOperationException("can't instantiate NetworkUtils.");
    }
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) ApplicationUtils.getApp().getSystemService(Context.WIFI_SERVICE);
