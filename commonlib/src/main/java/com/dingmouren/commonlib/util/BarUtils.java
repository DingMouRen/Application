 ...
 * 状态栏、通知栏、导航栏的工具类
 ...
 setStatusBarLightMode                : 设置状态栏是否为浅色模式(6.0以上有效)设置状态栏文字颜色，浅色模式时文字显示为黑色，非浅色模式时文字显示是白色
...
public class BarUtils {
    ...
    private BarUtils() {
        throw new UnsupportedOperationException("can't instantiate BarUtils");
    }
    ...
    /**
     * （6.0以上）设置状态栏文字颜色，浅色模式时文字显示为黑色，非浅色模式时文字显示是白色
     *
     * @param activity    The activity.
