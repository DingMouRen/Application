...
/**
 * Created by dingmouren on 2018/3/23.
...
public class AppUtils {
    private AppUtils() {
        throw new UnsupportedOperationException("can't instantiate AppUtils");
    }
    ...
    public static void installApp(final File file, final String authority) {
        ...
        ApplicationUtils.getApp().startActivity(IntentUtils.getInstallAppIntent(file, authority, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        ApplicationUtils.getApp().startActivity(IntentUtils.getUninstallAppIntent(packageName, true));
    }
    ...
    public static void launchApp(final String packageName) {
        if (isSpace(packageName)) return;
        ApplicationUtils.getApp().startActivity(IntentUtils.getLaunchAppIntent(packageName, true));
    }
