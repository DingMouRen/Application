...
public final class ToastUtils {
    ...
    private static void show(@StringRes final int resId, final int duration) {
        show(ApplicationUtils.getApp().getResources().getText(resId).toString(), duration);
    }

    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(ApplicationUtils.getApp().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = Toast.makeText(ApplicationUtils.getApp(), text, duration);
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = new Toast(ApplicationUtils.getApp());
                sToast.setView(view);
